...
(
    t_uuid CHAR(32) PRIMARY KEY NOT NULL,
    t_name CHAR(100)            NOT NULL,
    t_type CHAR(100)            NOT NULL,
    t_note CHAR(100)
);
INSERT INTO meta_table (t_uuid, t_name, t_type, t_note)
VALUES ('aaaa1111aaaa2222', 'test_table', '123456','this is a test table');
INSERT INTO meta_table (t_uuid, t_name, t_type, t_note)
VALUES ('cccc3333dddd2444', 'test_table', '123456','this is a test table');
